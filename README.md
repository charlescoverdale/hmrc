...
[![R-CMD-check](https://github.com/charlescoverdale/hmrc/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/charlescoverdale/hmrc/actions/workflows/R-CMD-check.yaml) [![CRAN status](https://www.r-pkg.org/badges/version/hmrc)](https://CRAN.R-project.org/package=hmrc) [![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable)
