...
#> ✔ Resolving download URL from GOV.UK Content API [542ms]
#> 
#> ℹ Downloading data file
#> ✔ Downloading data file [852ms]
#> 
#> ℹ Parsing data
#> ✔ Parsing data [53ms]
#> 
...
#> # Fetched 2026-05-04 19:13:25 UTC | Vintage: latest | Cells: estimates | Freq: annual | 34 rows x 7 cols
#> 
#>    tax_year                                 tax
...
#> # Measuring Tax Gaps
#> # Source: https://www.gov.uk/government/statistics/measuring-tax-gaps-tables
#> # Fetched 2026-05-04 19:13:25 UTC | Vintage: latest | Cells: estimates | Freq: annual | 1 rows x 7 cols
#> 
