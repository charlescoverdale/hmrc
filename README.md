...
| `list_tax_heads()` | Catalogue of all tax head identifiers - nodownload needed | - |
...
All downloads are cached locally in your user cache directory. Subsequent calls return the cached copy instantly - nonetwork request is made.
